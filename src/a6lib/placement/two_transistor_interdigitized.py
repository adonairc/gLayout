...
from a6lib.util.comp_utils import evaluate_bbox, prec_ref_center, transformed, align_comp_to_port
from typing import Literal, Union
from a6lib.util.port_utils import rename_ports_by_orientation, rename_ports_by_list, create_private_ports
from a6lib.routing.straight_route import straight_route
from a6lib.primitives.guardring import tapring
from a6lib.util.port_utils import add_ports_perimeter
from gdsfactory import clear_cache
import uuid

#from a6lib.placement.two_transistor_interdigitized import two_nfet_interdigitized; from a6lib.pdk.sky130_mapped import sky130_mapped_pdk as pdk; biasParams=[6,2,4]; rmult=2
...
def macro_two_transistor_interdigitized(
    ...
    ****NOTE: These are the same as a6lib.primitives.fet.multiplier arguments EXCLUDING dummy, sd_route_extension, and pdk options
    """
