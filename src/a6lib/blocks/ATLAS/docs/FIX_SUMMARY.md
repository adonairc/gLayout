...
4. **`a6lib/flow/blocks/elementary/LHS/transmission_gate.py`**
...
5. **`a6lib/flow/blocks/elementary/transmission_gate/transmission_gate.py`**
   - Fixed transmission_gate function (line ~131)
   - Updated tg_netlist function for consistency
   - Added `get_component_netlist()` helper function

6. **`a6lib/flow/blocks/elementary/LHS/fvf.py`**
   - Fixed flipped_voltage_follower function (line ~162)
   - Updated fvf_netlist function with helper function
   - Added `get_component_netlist()` helper function

### Composite Block Files
7. **`a6lib/flow/blocks/composite/fvf_based_ota/low_voltage_cmirror.py`**
   - Fixed netlist storage (line ~143)

8. **`a6lib/flow/blocks/composite/fvf_based_ota/p_block.py`**
   - Fixed netlist storage (line ~92)

9. **`a6lib/flow/blocks/composite/fvf_based_ota/n_block.py`**
