...
from a6lib import MappedPDK, sky130,gf180
from a6lib.routing import c_route,L_route,straight_route
from gdsfactory.component import Component, copy
from gdsfactory.component_reference import ComponentReference
from gdsfactory.components.rectangle import rectangle
from a6lib.pdk.mappedpdk import MappedPDK
from typing import Union
from a6lib.blocks.elementary.diff_pair.diff_pair import diff_pair
...
from a6lib.util.comp_utils import evaluate_bbox, prec_ref_center, movex, movey, to_decimal, to_float, move, align_comp_to_port, get_padding_points_cc
from a6lib.util.port_utils import rename_ports_by_orientation, rename_ports_by_list, add_ports_perimeter, print_ports, set_port_orientation, rename_component_ports
from a6lib.util.snap_to_grid import component_snap_to_grid
...
def __create_sharedgatecomps(pdk: MappedPDK, rmult: int, half_pload: tuple[float,float,int]) -> tuple:
    ...
    pcompR.add_ports(tapref.ports,prefix="welltap_")
    ...
    twomultpcomps.add_ports(_prefL.ports,prefix="L_")
    twomultpcomps.add_ports(_prefR.ports,prefix="R_")
...
def __route_sharedgatecomps(pdk: MappedPDK, shared_gate_comps, via_location, ptop_AB, pbottom_AB, LRplusdopedPorts, LRgatePorts, LRdrainsPorts, LRsourcesPorts,LRdummyports) -> Component:
    ...
    shared_gate_comps.add_ports(pcomps_2L_2R_sourcevia.ports,prefix="2L2Rsrcvia_")
    # short all the gates
    shared_gate_comps << route_quad(LRgatePorts[0],LRgatePorts[-1],layer=pdk.get_glayer("met2"))
    shared_gate_comps.add_ports(ptop_AB.ports,prefix="ptopAB_")
    shared_gate_comps.add_ports(pbottom_AB.ports,prefix="pbottomAB_")
    ...
    shared_gate_comps.add_ports(pmos_bdrain_diffpair_v.ports,prefix="minusvia_")
    shared_gate_comps.add_ports(mimcap_connection_ref.ports,prefix="mimcap_connection_")
