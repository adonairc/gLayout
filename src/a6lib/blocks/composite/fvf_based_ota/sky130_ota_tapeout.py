...
from a6lib.pdk.util.comp_utils import prec_array, movey, align_comp_to_port, prec_ref_center
from a6lib.pdk.util.port_utils import add_ports_perimeter, print_ports
from gdsfactory.component import Component
from a6lib.pdk.mappedpdk import MappedPDK
from a6lib.blocks.composite.fvf_based_ota.ota import super_class_AB_OTA
...
from gdsfactory.components import text_freetype, rectangle
from a6lib.pdk.mappedpdk import MappedPDK
from a6lib.primitives.via_gen import via_array, via_stack
...
import argparse
from a6lib.pdk.sky130_mapped import sky130_mapped_pdk as pdk
from itertools import count, repeat
from a6lib.pdk.util.component_array_create import write_component_matrix
import re
import pickle
import tempfile
import subprocess
...
if __name__ == "__main__":
    ...
    if args.mode=="gen_ota":
        ...
        if args.pdk[0].lower()=="g":
            from a6lib.pdk.gf180_mapped import gf180_mapped_pdk
