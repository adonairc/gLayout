...
Used as voltage shifters. Also used to crete a low voltage current mirror for biasing. Pcell can be found under ``` a6lib/flow/blocks/elementary/FVF/ ```
### Transmission gate
Due to unavailability of resistors in A6lib, trasmission gates were used as LCMFB resistors. However, this limits the slew performance. Pcell can be found here ``` a6lib/flow/blocks/elementary/trasmission_gate/ ```
...
This file is used for layout generation, PEX and post-layout simulations. [sky130_nist_tapeout.py](https://github.com/idea-fasoc/OpenFASOC/blob/main/openfasoc/generators/a6lib/tapeout/tapeout_and_RL/sky130_nist_tapeout.py) was taken as a reference.
