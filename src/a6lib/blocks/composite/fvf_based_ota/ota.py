...
from a6lib.pdk.sky130_mapped import sky130_mapped_pdk
import uuid
from gdsfactory import Component
from gdsfactory.cell import cell
from gdsfactory.component_reference import ComponentReference

from a6lib.pdk.util.comp_utils import evaluate_bbox, prec_ref_center, prec_center, align_comp_to_port
from a6lib.pdk.util.port_utils import rename_ports_by_orientation
from a6lib.pdk.util.snap_to_grid import component_snap_to_grid
from gdsfactory.components import text_freetype, rectangle
from a6lib.spice.netlist import Netlist


from a6lib.routing.straight_route import straight_route
from a6lib.routing.c_route import c_route
from a6lib.routing.L_route import L_route
from a6lib.blocks.elementary.FVF.fvf import fvf_netlist, flipped_voltage_follower
...
from a6lib.blocks.elementary.transmission_gate.transmission_gate import transmission_gate,tg_netlist
from a6lib.blocks.composite.fvf_based_ota.p_block import p_block,p_block_netlist
from a6lib.blocks.composite.fvf_based_ota.n_block import n_block,n_block_netlist
...
def super_class_AB_OTA(
    ...
    VCC_int_via = prec_ref_center(arrm2m3_2_vcc)
    ...
    # Create separate via_array instance for GND to avoid reference conflicts
    arrm2m3_2_gnd = via_array(
        pdk,
        "met2",
        "met3",
        num_vias=(2,2),
    ...
    GND_via = top_level << arrm2m3_2_gnd
