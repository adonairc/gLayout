        ...
        if pdk_root is None:
            ...
            if klayout_drc_file is None:
                ...
                if pdk == 'sky130':
                    ...
                    ## It is supplied along with a6lib package (at /pdk/gf180_mapped/), so we can use it from A6lib repo-root
                else:
            ...
            if pdk == 'ihp130':
                ...
                if lvs_schematic_ref_file is None:
                    if pdk == 'gf180':
                        ## It is supplied along with a6lib package (at /pdk/gf180_mapped/), so we can use it from A6lib base
